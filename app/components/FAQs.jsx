          ...
          <div key={index} className="w-full">
            ...
            <button
              ...
              className={`w-full text-left py-4 px-6 flex justify-between items-center rounded-xl font-bold transition-all duration-300 ${
                activeIndex === index ? "bg-teal-600 text-white rounded-t-xl rounded-b-none" : "bg-gray-200 text-gray-900"
              }`}
            >
            ...
            <div
              className={`overflow-hidden transition-all duration-500 ease-in-out ${
                activeIndex === index ? "max-h-40 opacity-100 py-4 px-6 rounded-b-xl bg-white" : "max-h-0 opacity-0"
              }`}
            >
